...
@click.option(
    "--repos",
    "-r",
    help='File with JSON array of GitHub API URLs for repos (if value is "file:<filename>") '
...
def licenses_handler(
    repos_json: str, interval: float, min_rate_limit: int, outfile: str
) -> None:
    """
